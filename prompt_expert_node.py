...
class PromptExpertNode:
    """
    一个ComfyUI节点，用于生成和翻译AI绘画提示词，具有专业提示词工程专家的能力。
    ...
    def process_prompt(self, input_text, input_fanyi, input_tishici, api_type, api_key, ollama_api_url, model_name, target_language):
        if '翻译' in input_text:system_prompt = input_fanyi
        else:system_prompt = input_tishici
        ...
        try:
            ...
            return (" (masterpiece:1.0), (highest quality:1.12), (HDR:1.0),synchronization, detailed, realistic, 8k uhd, high quality "+clean_output, translated_output)
